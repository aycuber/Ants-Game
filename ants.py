...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not place.is_hive:
            if random_bee(place.bees) and self.lower_bound <= curr <= self.upper_bound:
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        curr = self.place
        while curr.exit is not None:
            curr = curr.exit
            if curr.ant:
                curr.ant.double()
                if curr.ant.is_container and curr.ant.ant_contained is not None:
